                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="nis" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Nama Siswa</label>
                                <div class="col-md-12">
                                    <input type="text" name="nama_siswa" class="form-control form-control-line"> </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-12">Nama Orang Tua</label>
                                <div class="col-sm-12">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="pass_siswa" class="form-control form-control-line"> </div>
                            </div>

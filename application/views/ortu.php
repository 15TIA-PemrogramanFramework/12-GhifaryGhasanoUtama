...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-12">
                        <h4 class="page-title">Tabel Orang Tua Siswa</h4>
    ...
    <div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
        <?php echo anchor(site_url("home/tambah_ortu"),'<i class="fa fa-plus">&nbsp;Tambah Orang Tua</i>', 'class="btn btn-primary"');?>
    </div>
</div>
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php foreach ($ortu as $key => $value) { ?>
                                        <tr><td><?php echo $value->id_ortu; ?></td>
                                            ...
                                            <td>
                                            <button ><?php echo anchor(site_url("home/edit_ortu/".$value->id_ortu),

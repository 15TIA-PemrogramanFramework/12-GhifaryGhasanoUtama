...
<body>
    ...
    <div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
        <?php echo anchor(site_url("home/tambah_kelas"),'<i class="fa fa-plus">&nbsp;Tambah Kelas</i>', 'class="btn btn-primary"');?>
    </div>
</div>
                        <div class="white-box">
                                     ...
                                     <?php foreach ($kelas as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $value->nama_kelas; ?></td>
                                                ...
                                                <td>
                                            <button ><?php echo anchor(site_url("home/edit_kelas/".$value->kode_kelas),

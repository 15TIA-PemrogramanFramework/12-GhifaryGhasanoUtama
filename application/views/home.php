...
<body>
    ...
    <div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
        <?php echo anchor(site_url("home/input"),'<i class="fa fa-plus">&nbsp;Tambah Nilai</i>', 'class="btn btn-primary"');?>
    </div>
</div>
                        <div class="white-box">
                                    ...
                                    <?php foreach ($nilai as $key => $value) { ?>
                                        <tr>
                                           <td><?php echo $value->nasis; ?></td>
                                            ...
                                            <td><button ><?php echo anchor(site_url("home/edit/".$value->id_nilai),
                    '<i class="fa fa-trash">Edit Data</i>');?>&nbsp;</button>&nbsp;
                                            <button><?php echo anchor(site_url("home/hapus/".$value->id_nilai),
                    '<i class="fa fa-trash">Hapus Data</i>');?>&nbsp;</button></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>

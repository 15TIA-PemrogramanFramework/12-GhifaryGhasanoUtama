        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-12">
                        <h4 class="page-title">Tambah Orang Tua Siswa</h4>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                <label class="col-md-12">ID Orang Tua</label>
                                <div class="col-md-12">
                                    <input type="text" name="id_ortu" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Nama Orang Tua</label>
                                <div class="col-md-12">
                                    <input type="text" name="nama_ortu" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Alamat</label>
                                <div class="col-md-12">
                                    <input type="text" name="alamat_ortu" class="form-control form-control-line"> </div>
                            </div>
                            
                             <div class="form-group">
                                <label class="col-md-12">Gender</label>
                                <div class="col-md-12">
                                    <input type="text" name="gender" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Agama</label>
                                <div class="col-md-12">
                                    <input type="text" name="agama" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Nomor Hp/Telepon</label>
                                <div class="col-md-12">
                                    <input type="text" name="telp" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Perkerjaan</label>
                                <div class="col-md-12">
                                    <input type="text" name="pekerjaan" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Status</label>
                                <div class="col-md-12">
                                    <input type="text" name="status" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Password Akun</label>
                                <div class="col-md-12">
                                    <input type="text" name="pass" class="form-control form-control-line"> </div>
                            </div>

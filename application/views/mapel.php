...
<body>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-12">
                        <h4 class="page-title">Tabel Mapel</h4>
    ...
    <div class="col-md-12 text-right" style="margin-top:20px; margin-bottom:20px;">
        <?php echo anchor(site_url("home/tambah_mapel"),'<i class="fa fa-plus">&nbsp;Tambah Mapel</i>', 'class="btn btn-primary"');?>
    </div>
</div>
                        <div class="white-box">
                                     ...
                                     <?php foreach ($mapel as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $value->nama_mapel; ?></td>
                                                ...
                                                <td>
                                            <button ><?php echo anchor(site_url("home/edit_mapel/".$value->kode_mapel),

                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" action="<?php echo $action;?>" method="post">
                                    ...
                                    <input type="hidden" name="nik" value="<?php echo $nik; ?>" class="form-control form-control-line"> 
                            
                             <div class="form-group">
                                <label class="col-md-12">Nama Guru</label>
                                <div class="col-md-12">
                                    <input type="text" name="nama_guru" value="<?php echo $nama_guru; ?>" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Alamat</label>
                                <div class="col-md-12">
                                    <input type="text" name="alamat_guru" value="<?php echo $alamat_guru; ?>" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Tempat Lahir</label>
                                <div class="col-md-12">
                                    <input type="text" name="tmp_lahir" value="<?php echo $tmp_lahir; ?>" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Tanggal Lahir</label>
                                <div class="col-md-12">
                                    <input type="date" name="tgl_lahir" value="<?php echo $tgl_lahir; ?>" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                                <label class="col-md-12">Gender</label>
                                <div class="col-md-12">
                                    <input type="text" name="gender" value="<?php echo $tgl_lahir; ?>" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="pendidikan" value="<?php echo $pendidikan; ?>" class="form-control form-control-line"> </div>
                            </div>
                             <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="pass_guru" value="<?php echo $pass_guru; ?>" class="form-control form-control-line"> </div>
                            </div>

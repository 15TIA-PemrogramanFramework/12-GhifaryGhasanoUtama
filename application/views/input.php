                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                <label class="col-sm-12">Nama Siswa</label>
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="nis">
                                    <?php foreach ($siswa as $key => $value) { ?>
                                        <option value="<?php echo $value->nis; ?>"><?php echo $value->nama_siswa; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="kode_mapel">
                                    <?php foreach ($mapel as $key => $value) { ?>
                                        <option value="<?php echo $value->kode_mapel; ?>"><?php echo $value->nama_mapel; ?></option>
                            ...
                            <div class="form-group">
                                <label class="col-sm-12">Nama Guru</label>
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="nik">
                                    <?php foreach ($guru as $key => $value) { ?>
                                        <option value="<?php echo $value->nik; ?>"><?php echo $value->nama_guru; ?></option>
                            ...
                            <div class="form-group">
                                <label class="col-md-12">Nilai Harian</label>
                                <div class="col-md-12">
                                    <input type="text" name="nilai_harian" class="form-control form-control-line"> </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Nilai Ulangan</label>
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" name="nilai_ulangan" id="example-email"> </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Nilai UTS</label>
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" name="nilai_uts" id="example-email"> </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Nilai UAS</label>
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" name="nilai_uas" id="example-email"> </div>
                            </div>

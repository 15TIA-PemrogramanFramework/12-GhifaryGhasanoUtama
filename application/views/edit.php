                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="nilai_harian" value="<?php echo $nilai_harian; ?>" class="form-control form-control-line"> 
                                    </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Nilai Ulangan</label>
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" value="<?php echo $nilai_ulangan; ?>" name="nilai_ulangan" id="example-email"> </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Nilai UTS</label>
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" value="<?php echo $nilai_uts; ?>" name="nilai_uts" id="example-email"> </div>
                            </div>
                            <div class="form-group">
                                <label for="example-email" class="col-md-12">Nilai UAS</label>
                                <div class="col-md-12">
                                    <input type="text"  class="form-control form-control-line" value="<?php echo $nilai_uas; ?>" name="nilai_uas" id="example-email"> </div>
                            </div>
